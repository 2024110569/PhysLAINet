...
MODEL_PATH = "checkpoints/svr_LAI_model.pkl"
SCALER_PATH = "checkpoints/svr_LAI_scaler.pkl"
DATA_PATH = "../data/2023/2023_yvmi_params.xlsx"
OUTPUT_DIR = "test_results_svr"
...
def run_svr_test():
    ...
    plt.tight_layout()
    img_save_path = os.path.join(OUTPUT_DIR, "svr_2023_comparison_raw_scale.png")
