...
MODEL_PATH = "checkpoints/mlp_LAI_model.pkl"
SCALER_PATH = "checkpoints/mlp_LAI_scaler.pkl"
DATA_PATH = "../data/2023/2023_yvmi_params.xlsx"
OUTPUT_DIR = "test_results_mlp"
...
def run_mlp_test():
    ...
    plt.tight_layout()
    img_save_path = os.path.join(OUTPUT_DIR, "mlp_2023_comparison_raw.png")
