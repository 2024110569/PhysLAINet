...
def plot_true_vs_pred(y_true, y_pred, dataset_name):
    ...
    plt.tight_layout()
    plt.savefig(f"vs/RF_{target_col}_{dataset_name}.png", dpi=300)
    plt.show()

plot_true_vs_pred(y_trainval, y_trainval_pred, "Train_Valid")
plot_true_vs_pred(y_test, y_test_pred, "Test")
joblib.dump(final_model, f"checkpoints/rfr_{target_col}_model.pkl")
joblib.dump(scaler, f"checkpoints/rfr_{target_col}_scaler.pkl")
