...
Considering the extremely large size of raw image data (up to several hundred gigabytes), only structured data with pre-extracted features is uploaded here.
---
## Note: Web system
